...
import { generateMockCollabRequests } from '@/lib/mock-data';

const initialReceivedRequests = generateMockCollabRequests(15, 'received');
const initialSentRequests = generateMockCollabRequests(25, 'sent');
...
export default function CollabRequestsPage() {
  ...
  const [receivedRequests, setReceivedRequests] = useState<Request[]>(initialReceivedRequests);
  const [sentRequests, setSentRequests] = useState<Request[]>(initialSentRequests);
      ...
      <Tabs defaultValue="received" className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="received">
            <Briefcase className="mr-2 h-4 w-4" /> Received ({receivedRequests.length})
          </TabsTrigger>
